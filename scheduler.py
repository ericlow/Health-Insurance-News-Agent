...
from agent.caloptima_monitor import run_monitor as caloptima_run_monitor, LISTING_URL as CALOPTIMA_LISTING_URL
...
def run_pipeline():
    ...
    _caloptima_run_id, caloptima_new_ids = caloptima_run_monitor()
    ...
    log.info(
        ...
        len(hoag_new_ids), len(john_muir_new_ids), len(caloptima_new_ids),
    )
    ...
    post_health_check("CalOptima Health", fetch_verdicts_for_articles(caloptima_new_ids),
                      web_url='https://www.caloptima.org/about-us/news-and-media', feed_url=CALOPTIMA_LISTING_URL)
