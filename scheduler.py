...
from agent.aetna_monitor import run_monitor as aetna_run_monitor, LISTING_URL as AETNA_LISTING_URL
...
def run_pipeline():
    ...
    _aetna_run_id, aetna_new_ids = aetna_run_monitor()
    ...
    log.info(
        ...
        len(hoag_new_ids), len(john_muir_new_ids), len(aetna_new_ids),
    )
    ...
    post_health_check("Aetna Newsroom", fetch_verdicts_for_articles(aetna_new_ids),
                      web_url=AETNA_LISTING_URL, feed_url=AETNA_LISTING_URL)
