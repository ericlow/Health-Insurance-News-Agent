...
from agent.city_of_hope_monitor import run_monitor as city_of_hope_run_monitor, LISTING_URL as CITY_OF_HOPE_LISTING_URL
...
def run_pipeline():
    ...
    log.info(
        ...
        len(hoag_new_ids), len(john_muir_new_ids), len(city_of_hope_new_ids),
    )
    ...
    post_health_check("City of Hope", fetch_verdicts_for_articles(city_of_hope_new_ids),
                      web_url=CITY_OF_HOPE_LISTING_URL, feed_url=CITY_OF_HOPE_LISTING_URL)
