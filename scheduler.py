...
from agent.uhg_monitor import run_monitor as uhg_run_monitor, LISTING_URL as UHG_LISTING_URL
...
def run_pipeline():
    ...
    _uhg_run_id, uhg_new_ids = uhg_run_monitor()
    ...
    log.info(
        ...
        len(hoag_new_ids), len(john_muir_new_ids), len(uhg_new_ids),
    )
    ...
    post_health_check("UnitedHealth Group", fetch_verdicts_for_articles(uhg_new_ids),
                      web_url=UHG_LISTING_URL, feed_url=UHG_LISTING_URL)
