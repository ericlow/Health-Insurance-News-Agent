...
**Base case (LOW — modeled): CalOptima gains ~7,500 members in year 1 (range 3,050–14,750)** — the auto-assignment pipeline, converted at a continuity-boosted effectuation rate, is its largest component. Anthem's impact comes in two parts. First, ~1,100–1,500 existing members switch away (~$12–15M in gross premium). Second, Anthem stops receiving the ~2,750 new members per year that SB 260 auto-enrollment currently delivers to it. **Combined, Anthem ends 2027 roughly 3,850–4,250 members (~$38–42M in annual gross premium) smaller than it would have been had CalOptima not entered** — about 3x the rev-2 estimate. Risk adjustment remains a partial offset (Anthem paid $435.1M into the CA individual pool in BY2024 [S3 — HIGH]; losing/forgoing thin-coded members shrinks that), and the statewide pool barely moves (<0.6% of 2.19M members [S2 — HIGH]). Individual pool only; small group unaffected.
